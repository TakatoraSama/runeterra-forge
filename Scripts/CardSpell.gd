...
func _ready() -> void:
	...
	_dissolve_mat = mat
	for path in ["CardFront/CardSpellSpriteBase", "CardFront/CardSpellSpriteParent/CardSpellSprite",
			"CardFront/CardMana", "CardFront/CardTextBase", "CardFront/CardTextShadowBase"]:
